                      ...
                      <div className="bg-blue-50 rounded-lg p-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-lg font-bold text-blue-600">{parseFloat(dashboardData.stats.monthlyRevenue).toFixed(2)} €</p>
                          </div>
                        </div>
                      </div>
                      <div className="bg-green-50 rounded-lg p-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-lg font-bold text-green-600">{parseFloat(dashboardData.stats.potentialRevenue).toFixed(2)} €</p>
                          </div>
                        </div>
                      </div>
                      <div className="bg-blue-50 rounded-lg p-4">
                      ...
                      <div className="bg-red-50 rounded-lg p-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-lg font-bold text-red-600">{parseFloat(dashboardData.stats.unpaidAmount).toFixed(2)} €</p>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-lg p-6 border border-gray-100">
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${dashboardData.paymentStatus === 'à jour'
                  ...
                  <div className="mt-6 text-center">
                    <Link href="/payments" className="inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
