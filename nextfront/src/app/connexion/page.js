      ...
      <div className="flex items-center justify-center py-16 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-[440px] bg-white rounded-lg p-5">
          <div className="text-center mb-3">
            ...
            <p className="text-sm text-gray-600">Accédez à votre espace de gestion</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  id="password"
                  className="w-full pl-9 pr-9 py-1.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900"
                  value={password}
