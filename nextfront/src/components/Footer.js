        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-semibold text-gray-900">Gestion Locative</span>
            </div>
            <p className="text-gray-600 mb-6 max-w-md">
              La solution complète pour la gestion de vos biens immobiliers et de vos locataires. Simplifiez votre gestion locative au quotidien.
            </p>
